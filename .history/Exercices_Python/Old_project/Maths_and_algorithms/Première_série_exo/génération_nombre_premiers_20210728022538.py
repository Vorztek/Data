...
class nb_premiers_verif():
    ...
    def __init__(self, self.compte, self.valeur, self.compteur):
        self.compte = 0
        self.valeur = 300 #int(input("Veuillez saisir le nombre maximal de l'intervalle où seront cherchés les nombre premiers : "))
        self.compteur = []
